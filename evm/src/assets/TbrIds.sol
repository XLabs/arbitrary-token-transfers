...
uint8 constant IS_CHAIN_SUPPORTED = 0x86;
uint8 constant PENDING_OWNER = 0x87;
uint8 constant ADMIN = 0x88;
uint8 constant FEE_RECIPIENT = 0x89;
uint8 constant IMPLEMENTATION = 0x8A;