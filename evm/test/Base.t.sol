...
contract BaseTest is TbrTestBase {
  ...
  function testSetRelayFee(uint16 chainId, uint32 fee) public {
    tbrExposer.exposedSetRelayFee(chainId, fee);
    uint32 relayFee = tbrExposer.exposedGetRelayFee(chainId);
