...
export interface PriceOracleConfigInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PriceOracleConfig extends BaseContract {
  connect(runner?: ContractRunner | null): PriceOracleConfig;
  waitForDeployment(): Promise<this>;

  interface: PriceOracleConfigInterface;
