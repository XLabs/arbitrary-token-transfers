...
export interface PriceOracleDispatcherInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PriceOracleDispatcher extends BaseContract {
  connect(runner?: ContractRunner | null): PriceOracleDispatcher;
  waitForDeployment(): Promise<this>;

  interface: PriceOracleDispatcherInterface;
