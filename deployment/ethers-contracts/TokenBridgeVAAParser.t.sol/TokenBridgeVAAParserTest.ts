...
export interface TokenBridgeVAAParserTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface TokenBridgeVAAParserTest extends BaseContract {
  connect(runner?: ContractRunner | null): TokenBridgeVAAParserTest;
  waitForDeployment(): Promise<this>;

  interface: TokenBridgeVAAParserTestInterface;
  ...
  parse: TypedContractMethod<
    [data: BytesLike, offset: BigNumberish, commandIndex: BigNumberish],
    [
      [
        string,
        bigint,
  ...
  testParseVaa: TypedContractMethod<
    [
