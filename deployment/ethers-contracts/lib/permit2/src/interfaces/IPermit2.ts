...
export declare namespace IAllowanceTransfer {
    ...
    export type TokenSpenderPairStruct = {token: AddressLike, spender: AddressLike}

    export type TokenSpenderPairStructOutput = [token: string, spender: string] & {token: string, spender: string }
  

    export type PermitDetailsStruct = {token: AddressLike, amount: BigNumberish, expiration: BigNumberish, nonce: BigNumberish}

    export type PermitDetailsStructOutput = [token: string, amount: bigint, expiration: bigint, nonce: bigint] & {token: string, amount: bigint, expiration: bigint, nonce: bigint }
  

    export type PermitBatchStruct = {details: IAllowanceTransfer.PermitDetailsStruct[], spender: AddressLike, sigDeadline: BigNumberish}

    export type PermitBatchStructOutput = [details: IAllowanceTransfer.PermitDetailsStructOutput[], spender: string, sigDeadline: bigint] & {details: IAllowanceTransfer.PermitDetailsStructOutput[], spender: string, sigDeadline: bigint }
  

    export type PermitSingleStruct = {details: IAllowanceTransfer.PermitDetailsStruct, spender: AddressLike, sigDeadline: BigNumberish}

    export type PermitSingleStructOutput = [details: IAllowanceTransfer.PermitDetailsStructOutput, spender: string, sigDeadline: bigint] & {details: IAllowanceTransfer.PermitDetailsStructOutput, spender: string, sigDeadline: bigint }
  

    export type AllowanceTransferDetailsStruct = {from: AddressLike, to: AddressLike, amount: BigNumberish, token: AddressLike}

    export type AllowanceTransferDetailsStructOutput = [from: string, to: string, amount: bigint, token: string] & {from: string, to: string, amount: bigint, token: string }
  
    }

export declare namespace ISignatureTransfer {
      
    export type TokenPermissionsStruct = {token: AddressLike, amount: BigNumberish}

    export type TokenPermissionsStructOutput = [token: string, amount: bigint] & {token: string, amount: bigint }
  

    export type PermitTransferFromStruct = {permitted: ISignatureTransfer.TokenPermissionsStruct, nonce: BigNumberish, deadline: BigNumberish}

    export type PermitTransferFromStructOutput = [permitted: ISignatureTransfer.TokenPermissionsStructOutput, nonce: bigint, deadline: bigint] & {permitted: ISignatureTransfer.TokenPermissionsStructOutput, nonce: bigint, deadline: bigint }
  

    export type SignatureTransferDetailsStruct = {to: AddressLike, requestedAmount: BigNumberish}

    export type SignatureTransferDetailsStructOutput = [to: string, requestedAmount: bigint] & {to: string, requestedAmount: bigint }
  

    export type PermitBatchTransferFromStruct = {permitted: ISignatureTransfer.TokenPermissionsStruct[], nonce: BigNumberish, deadline: BigNumberish}

    export type PermitBatchTransferFromStructOutput = [permitted: ISignatureTransfer.TokenPermissionsStructOutput[], nonce: bigint, deadline: bigint] & {permitted: ISignatureTransfer.TokenPermissionsStructOutput[], nonce: bigint, deadline: bigint }
...
encodeFunctionData(functionFragment: 'permitTransferFrom(((address,uint256),uint256,uint256),(address,uint256),address,bytes)', values: [ISignatureTransfer.PermitTransferFromStruct, ISignatureTransfer.SignatureTransferDetailsStruct, AddressLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'permitTransferFrom(((address,uint256)[],uint256,uint256),(address,uint256)[],address,bytes)', values: [ISignatureTransfer.PermitBatchTransferFromStruct, ISignatureTransfer.SignatureTransferDetailsStruct[], AddressLike, BytesLike]): string;
encodeFunctionData(functionFragment: 'permitWitnessTransferFrom(((address,uint256),uint256,uint256),(address,uint256),address,bytes32,string,bytes)', values: [ISignatureTransfer.PermitTransferFromStruct, ISignatureTransfer.SignatureTransferDetailsStruct, AddressLike, BytesLike, string, BytesLike]): string;
encodeFunctionData(functionFragment: 'permitWitnessTransferFrom(((address,uint256)[],uint256,uint256),(address,uint256)[],address,bytes32,string,bytes)', values: [ISignatureTransfer.PermitBatchTransferFromStruct, ISignatureTransfer.SignatureTransferDetailsStruct[], AddressLike, BytesLike, string, BytesLike]): string;
...
decodeFunctionResult(functionFragment: 'transferFrom(address,address,uint160,address)', data: BytesLike): Result;
    ...
    export namespace ApprovalEvent {
      export type InputTuple = [owner: AddressLike, token: AddressLike, spender: AddressLike, amount: BigNumberish, expiration: BigNumberish];
      export type OutputTuple = [owner: string, token: string, spender: string, amount: bigint, expiration: bigint];
      export interface OutputObject {owner: string, token: string, spender: string, amount: bigint, expiration: bigint };
    ...
    export namespace LockdownEvent {
      ...
      export interface OutputObject {owner: string, token: string, spender: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace NonceInvalidationEvent {
      export type InputTuple = [owner: AddressLike, token: AddressLike, spender: AddressLike, newNonce: BigNumberish, oldNonce: BigNumberish];
      export type OutputTuple = [owner: string, token: string, spender: string, newNonce: bigint, oldNonce: bigint];
      export interface OutputObject {owner: string, token: string, spender: string, newNonce: bigint, oldNonce: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
    ...
    export namespace PermitEvent {
      export type InputTuple = [owner: AddressLike, token: AddressLike, spender: AddressLike, amount: BigNumberish, expiration: BigNumberish, nonce: BigNumberish];
      export type OutputTuple = [owner: string, token: string, spender: string, amount: bigint, expiration: bigint, nonce: bigint];
    ...
    export namespace UnorderedNonceInvalidationEvent {
      ...
      export interface OutputObject {owner: string, word: bigint, mask: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    allowance: TypedContractMethod<
      ...
      [[bigint, bigint, bigint] & {amount: bigint, expiration: bigint, nonce: bigint }],
      'view'
    >
    ...
    "permitTransferFrom(((address,uint256),uint256,uint256),(address,uint256),address,bytes)": TypedContractMethod<
      [permit: ISignatureTransfer.PermitTransferFromStruct, transferDetails: ISignatureTransfer.SignatureTransferDetailsStruct, owner: AddressLike, signature: BytesLike, ],
      [void],
      'nonpayable'
    >
    ...
    "permitTransferFrom(((address,uint256)[],uint256,uint256),(address,uint256)[],address,bytes)": TypedContractMethod<
      [permit: ISignatureTransfer.PermitBatchTransferFromStruct, transferDetails: ISignatureTransfer.SignatureTransferDetailsStruct[], owner: AddressLike, signature: BytesLike, ],
      [void],
      'nonpayable'
    >
    ...
    "permitWitnessTransferFrom(((address,uint256),uint256,uint256),(address,uint256),address,bytes32,string,bytes)": TypedContractMethod<
      [permit: ISignatureTransfer.PermitTransferFromStruct, transferDetails: ISignatureTransfer.SignatureTransferDetailsStruct, owner: AddressLike, witness: BytesLike, witnessTypeString: string, signature: BytesLike, ],
      [void],
      'nonpayable'
    >
    ...
    "permitWitnessTransferFrom(((address,uint256)[],uint256,uint256),(address,uint256)[],address,bytes32,string,bytes)": TypedContractMethod<
      [permit: ISignatureTransfer.PermitBatchTransferFromStruct, transferDetails: ISignatureTransfer.SignatureTransferDetailsStruct[], owner: AddressLike, witness: BytesLike, witnessTypeString: string, signature: BytesLike, ],
      [void],
      'nonpayable'
    >
