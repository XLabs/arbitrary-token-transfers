...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../../../../common.js"
  ...
  export interface ProxyBaseInterface extends Interface {
    getFunction(nameOrSignature: "checkedUpgrade"): FunctionFragment;
  ...
  export interface ProxyBase extends BaseContract {
    
    connect(runner?: ContractRunner | null): ProxyBase;
