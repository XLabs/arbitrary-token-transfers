...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../../../../common.js"
  ...
  export interface PermitParsingInterface extends Interface {
  ...
  export interface PermitParsing extends BaseContract {
    
    connect(runner?: ContractRunner | null): PermitParsing;
    waitForDeployment(): Promise<this>;

    interface: PermitParsingInterface;
