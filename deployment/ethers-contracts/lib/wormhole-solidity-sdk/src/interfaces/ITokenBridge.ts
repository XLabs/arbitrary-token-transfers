...
export declare namespace ITokenBridge {
    ...
    export type TransferStruct = {payloadID: BigNumberish, amount: BigNumberish, tokenAddress: BytesLike, tokenChain: BigNumberish, to: BytesLike, toChain: BigNumberish, fee: BigNumberish}

    export type TransferStructOutput = [payloadID: bigint, amount: bigint, tokenAddress: string, tokenChain: bigint, to: string, toChain: bigint, fee: bigint] & {payloadID: bigint, amount: bigint, tokenAddress: string, tokenChain: bigint, to: string, toChain: bigint, fee: bigint }
  

    export type AssetMetaStruct = {payloadID: BigNumberish, tokenAddress: BytesLike, tokenChain: BigNumberish, decimals: BigNumberish, symbol: BytesLike, name: BytesLike}

    export type AssetMetaStructOutput = [payloadID: bigint, tokenAddress: string, tokenChain: bigint, decimals: bigint, symbol: string, name: string] & {payloadID: bigint, tokenAddress: string, tokenChain: bigint, decimals: bigint, symbol: string, name: string }
  

    export type TransferWithPayloadStruct = {payloadID: BigNumberish, amount: BigNumberish, tokenAddress: BytesLike, tokenChain: BigNumberish, to: BytesLike, toChain: BigNumberish, fromAddress: BytesLike, payload: BytesLike}

    export type TransferWithPayloadStructOutput = [payloadID: bigint, amount: bigint, tokenAddress: string, tokenChain: bigint, to: string, toChain: bigint, fromAddress: string, payload: string] & {payloadID: bigint, amount: bigint, tokenAddress: string, tokenChain: bigint, to: string, toChain: bigint, fromAddress: string, payload: string }
  

    export type RecoverChainIdStruct = {module: BytesLike, action: BigNumberish, evmChainId: BigNumberish, newChainId: BigNumberish}

    export type RecoverChainIdStructOutput = [module: string, action: bigint, evmChainId: bigint, newChainId: bigint] & {module: string, action: bigint, evmChainId: bigint, newChainId: bigint }
  

    export type RegisterChainStruct = {module: BytesLike, action: BigNumberish, chainId: BigNumberish, emitterChainID: BigNumberish, emitterAddress: BytesLike}

    export type RegisterChainStructOutput = [module: string, action: bigint, chainId: bigint, emitterChainID: bigint, emitterAddress: string] & {module: string, action: bigint, chainId: bigint, emitterChainID: bigint, emitterAddress: string }
  

    export type UpgradeContractStruct = {module: BytesLike, action: BigNumberish, chainId: BigNumberish, newContract: BytesLike}

    export type UpgradeContractStructOutput = [module: string, action: bigint, chainId: bigint, newContract: string] & {module: string, action: bigint, chainId: bigint, newContract: string }
  ...
  export interface ITokenBridgeInterface extends Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "ContractUpgraded" | "TransferRedeemed"): EventFragment;
...
encodeFunctionData(functionFragment: 'transferTokens', values: [AddressLike, BigNumberish, BigNumberish, BytesLike, BigNumberish, BigNumberish]): string;
encodeFunctionData(functionFragment: 'transferTokensWithPayload', values: [AddressLike, BigNumberish, BigNumberish, BytesLike, BigNumberish, BytesLike]): string;
...
decodeFunctionResult(functionFragment: 'wrappedAsset', data: BytesLike): Result;
    ...
    export namespace ContractUpgradedEvent {
      ...
      export interface OutputObject {oldContract: string, newContract: string };
    ...
    export namespace TransferRedeemedEvent {
      export type InputTuple = [emitterChainId: BigNumberish, emitterAddress: BytesLike, sequence: BigNumberish];
      export type OutputTuple = [emitterChainId: bigint, emitterAddress: string, sequence: bigint];
      export interface OutputObject {emitterChainId: bigint, emitterAddress: string, sequence: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    evmChainId: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    governanceChainId: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    governanceContract: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    isWrappedAsset: TypedContractMethod<
      [token: AddressLike, ],
      [boolean],
      'view'
    >
    ...
    parsePayloadID: TypedContractMethod<
      [encoded: BytesLike, ],
      [bigint],
      'view'
    >
    ...
    tokenImplementation: TypedContractMethod<
      [],
      [string],
      'view'
    >
    ...
    transferTokens: TypedContractMethod<
      [token: AddressLike, amount: BigNumberish, recipientChain: BigNumberish, recipient: BytesLike, arbiterFee: BigNumberish, nonce: BigNumberish, ],
      [bigint],
      'payable'
    >
    ...
    transferTokensWithPayload: TypedContractMethod<
      [token: AddressLike, amount: BigNumberish, recipientChain: BigNumberish, recipient: BytesLike, nonce: BigNumberish, payload: BytesLike, ],
      [bigint],
      'payable'
    >
    ...
    wrapAndTransferETH: TypedContractMethod<
      [recipientChain: BigNumberish, recipient: BytesLike, arbiterFee: BigNumberish, nonce: BigNumberish, ],
      [bigint],
      'payable'
    >
    ...
    wrapAndTransferETHWithPayload: TypedContractMethod<
      [recipientChain: BigNumberish, recipient: BytesLike, nonce: BigNumberish, payload: BytesLike, ],
      [bigint],
      'payable'
    >
...
getFunction(nameOrSignature: 'attestToken'): TypedContractMethod<
      ...
      'payable'
    >;
getFunction(nameOrSignature: 'bridgeContracts'): TypedContractMethod<
      [chainId_: BigNumberish, ],
      [string],
      'view'
    >;
getFunction(nameOrSignature: 'chainId'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'completeTransfer'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'completeTransferAndUnwrapETH'): TypedContractMethod<
      [encodedVm: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'completeTransferAndUnwrapETHWithPayload'): TypedContractMethod<
      [encodedVm: BytesLike, ],
      [string],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'completeTransferWithPayload'): TypedContractMethod<
      [encodedVm: BytesLike, ],
      [string],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'createWrapped'): TypedContractMethod<
      [encodedVm: BytesLike, ],
      [string],
      'nonpayable'
    >;
...
getFunction(nameOrSignature: 'encodeTransferWithPayload'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'evmChainId'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'finality'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'governanceActionIsConsumed'): TypedContractMethod<
      [hash: BytesLike, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'governanceChainId'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'governanceContract'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
...
getFunction(nameOrSignature: 'initialize'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'isFork'): TypedContractMethod<
      [],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'isInitialized'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'isTransferCompleted'): TypedContractMethod<
      [hash: BytesLike, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'isWrappedAsset'): TypedContractMethod<
      [token: AddressLike, ],
      [boolean],
      'view'
    >;
getFunction(nameOrSignature: 'outstandingBridged'): TypedContractMethod<
      [token: AddressLike, ],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'parseAssetMeta'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'parsePayloadID'): TypedContractMethod<
      [encoded: BytesLike, ],
      [bigint],
      'view'
    >;
...
getFunction(nameOrSignature: 'registerChain'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'submitRecoverChainId'): TypedContractMethod<
      [encodedVM: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'tokenImplementation'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
...
getFunction(nameOrSignature: 'transferTokensWithPayload'): TypedContractMethod<
      ...
      'payable'
    >;
getFunction(nameOrSignature: 'updateWrapped'): TypedContractMethod<
      [encodedVm: BytesLike, ],
      [string],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'upgrade'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'wormhole'): TypedContractMethod<
      [],
      [string],
      'view'
    >;
