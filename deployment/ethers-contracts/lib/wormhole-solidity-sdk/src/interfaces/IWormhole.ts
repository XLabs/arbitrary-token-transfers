...
export declare namespace IWormhole {
    ...
    export type GuardianSetStruct = {keys: AddressLike[], expirationTime: BigNumberish}

    export type GuardianSetStructOutput = [keys: string[], expirationTime: bigint] & {keys: string[], expirationTime: bigint }
  

    export type SignatureStruct = {r: BytesLike, s: BytesLike, v: BigNumberish, guardianIndex: BigNumberish}

    export type SignatureStructOutput = [r: string, s: string, v: bigint, guardianIndex: bigint] & {r: string, s: string, v: bigint, guardianIndex: bigint }
  

    export type VMStruct = {version: BigNumberish, timestamp: BigNumberish, nonce: BigNumberish, emitterChainId: BigNumberish, emitterAddress: BytesLike, sequence: BigNumberish, consistencyLevel: BigNumberish, payload: BytesLike, guardianSetIndex: BigNumberish, signatures: IWormhole.SignatureStruct[], hash: BytesLike}

    export type VMStructOutput = [version: bigint, timestamp: bigint, nonce: bigint, emitterChainId: bigint, emitterAddress: string, sequence: bigint, consistencyLevel: bigint, payload: string, guardianSetIndex: bigint, signatures: IWormhole.SignatureStructOutput[], hash: string] & {version: bigint, timestamp: bigint, nonce: bigint, emitterChainId: bigint, emitterAddress: string, sequence: bigint, consistencyLevel: bigint, payload: string, guardianSetIndex: bigint, signatures: IWormhole.SignatureStructOutput[], hash: string }
  

    export type ContractUpgradeStruct = {module: BytesLike, action: BigNumberish, chain: BigNumberish, newContract: AddressLike}

    export type ContractUpgradeStructOutput = [module: string, action: bigint, chain: bigint, newContract: string] & {module: string, action: bigint, chain: bigint, newContract: string }
  

    export type GuardianSetUpgradeStruct = {module: BytesLike, action: BigNumberish, chain: BigNumberish, newGuardianSet: IWormhole.GuardianSetStruct, newGuardianSetIndex: BigNumberish}

    export type GuardianSetUpgradeStructOutput = [module: string, action: bigint, chain: bigint, newGuardianSet: IWormhole.GuardianSetStructOutput, newGuardianSetIndex: bigint] & {module: string, action: bigint, chain: bigint, newGuardianSet: IWormhole.GuardianSetStructOutput, newGuardianSetIndex: bigint }
    ...
    export type SetMessageFeeStruct = {module: BytesLike, action: BigNumberish, chain: BigNumberish, messageFee: BigNumberish}

    export type SetMessageFeeStructOutput = [module: string, action: bigint, chain: bigint, messageFee: bigint] & {module: string, action: bigint, chain: bigint, messageFee: bigint }
  

    export type TransferFeesStruct = {module: BytesLike, action: BigNumberish, chain: BigNumberish, amount: BigNumberish, recipient: BytesLike}

    export type TransferFeesStructOutput = [module: string, action: bigint, chain: bigint, amount: bigint, recipient: string] & {module: string, action: bigint, chain: bigint, amount: bigint, recipient: string }
  ...
  export interface IWormholeInterface extends Interface {
    ...
    getEvent(nameOrSignatureOrTopic: "ContractUpgraded" | "GuardianSetAdded" | "LogMessagePublished"): EventFragment;
...
encodeFunctionData(functionFragment: 'verifySignatures', values: [BytesLike, IWormhole.SignatureStruct[], IWormhole.GuardianSetStruct]): string;
...
decodeFunctionResult(functionFragment: 'verifyVM', data: BytesLike): Result;
    ...
    export namespace LogMessagePublishedEvent {
      export type InputTuple = [sender: AddressLike, sequence: BigNumberish, nonce: BigNumberish, payload: BytesLike, consistencyLevel: BigNumberish];
      export type OutputTuple = [sender: string, sequence: bigint, nonce: bigint, payload: string, consistencyLevel: bigint];
      export interface OutputObject {sender: string, sequence: bigint, nonce: bigint, payload: string, consistencyLevel: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    getCurrentGuardianSetIndex: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    getGuardianSetExpiry: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    messageFee: TypedContractMethod<
      [],
      [bigint],
      'view'
    >
    ...
    nextSequence: TypedContractMethod<
      [emitter: AddressLike, ],
      [bigint],
      'view'
    >
    ...
    parseAndVerifyVM: TypedContractMethod<
      [encodedVM: BytesLike, ],
      [[IWormhole.VMStructOutput, boolean, string] & {vm: IWormhole.VMStructOutput, valid: boolean, reason: string }],
      'view'
    >
    ...
    verifySignatures: TypedContractMethod<
      [hash: BytesLike, signatures: IWormhole.SignatureStruct[], guardianSet: IWormhole.GuardianSetStruct, ],
...
getFunction(nameOrSignature: 'evmChainId'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getCurrentGuardianSetIndex'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'getGuardianSet'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'getGuardianSetExpiry'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
...
getFunction(nameOrSignature: 'isInitialized'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'messageFee'): TypedContractMethod<
      [],
      [bigint],
      'view'
    >;
getFunction(nameOrSignature: 'nextSequence'): TypedContractMethod<
      [emitter: AddressLike, ],
      [bigint],
      'view'
    >;
...
getFunction(nameOrSignature: 'quorum'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'submitContractUpgrade'): TypedContractMethod<
      [_vm: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'submitNewGuardianSet'): TypedContractMethod<
      [_vm: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'submitRecoverChainId'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'submitSetMessageFee'): TypedContractMethod<
      [_vm: BytesLike, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'submitTransferFees'): TypedContractMethod<
      [_vm: BytesLike, ],
      [void],
      'nonpayable'
    >;
