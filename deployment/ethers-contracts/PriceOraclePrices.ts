...
export interface PriceOraclePricesInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PriceOraclePrices extends BaseContract {
  connect(runner?: ContractRunner | null): PriceOraclePrices;
  waitForDeployment(): Promise<this>;

  interface: PriceOraclePricesInterface;
