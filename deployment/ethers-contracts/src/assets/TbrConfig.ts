...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface TbrConfigInterface extends Interface {
    getFunction(nameOrSignature: "cancelOwnershipTransfer" | "receiveOwnership" | "transferOwnership"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface TbrConfig extends BaseContract {
    
    connect(runner?: ContractRunner | null): TbrConfig;
    waitForDeployment(): Promise<this>;

    interface: TbrConfigInterface;
