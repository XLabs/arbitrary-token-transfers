...
export interface DispatcherTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
  ...
  encodeFunctionData(functionFragment: "testExec", values?: undefined): string;
  encodeFunctionData(functionFragment: "testGet", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "testExec", data: BytesLike): Result;
...
export interface DispatcherTest extends BaseContract {
  connect(runner?: ContractRunner | null): DispatcherTest;
  waitForDeployment(): Promise<this>;

  interface: DispatcherTestInterface;
  ...
  testExec: TypedContractMethod<[], [void], "nonpayable">;

  testGet: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "testExec"
  ): TypedContractMethod<[], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "testGet"
  ): TypedContractMethod<[], [void], "nonpayable">;
