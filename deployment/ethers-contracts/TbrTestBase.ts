...
export interface TbrTestBaseInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "IS_TEST"
      | "excludeArtifacts"
...
export interface TbrTestBase extends BaseContract {
  connect(runner?: ContractRunner | null): TbrTestBase;
  waitForDeployment(): Promise<this>;

  interface: TbrTestBaseInterface;
